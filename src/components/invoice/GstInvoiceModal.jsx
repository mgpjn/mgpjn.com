      ...
      <div className="bg-white rounded-3xl max-w-4xl w-full shadow-2xl overflow-hidden flex flex-col max-h-[92vh] print:max-h-none print:shadow-none print:rounded-none">
        ...
        <div className="px-6 py-4 bg-slate-900 text-white flex items-center justify-between print:hidden">
          ...
          <div className="flex items-center space-x-2">
            <button
              onClick={handlePrint}
              className="bg-brand-orange-500 hover:bg-brand-orange-600 text-white text-xs font-bold px-4 py-2 rounded-xl flex items-center space-x-1.5 transition-all shadow-md cursor-pointer"
            >
