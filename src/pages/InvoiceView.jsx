...
export default function InvoiceView() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-3 sm:px-4 py-4 space-y-3 print:p-0 print:m-0 print:max-w-none">
      ...
      <div className="flex items-center justify-between print:hidden">
        ...
        <div className="flex items-center space-x-2">
          ...
          <button
            onClick={handlePrint}
            className="bg-slate-800 hover:bg-slate-900 text-white text-xs font-bold px-3.5 py-1.5 rounded-lg flex items-center space-x-1.5 transition-all shadow-md cursor-pointer"
          >
      ...
      {/* Official Tax Invoice Container (with horizontal scroll on tiny mobile screens, but 740px fixed on PDF/print) */}
      <div className="overflow-x-auto print:overflow-visible">
        <div 
          ref={invoiceRef} 
          className="w-[740px] min-w-[740px] mx-auto bg-white p-3 rounded-xl border border-slate-300 shadow-sm print:shadow-none print:border-none print:p-0 print:w-full print:min-w-0 space-y-1.5 text-[9.5px] leading-tight font-sans text-slate-900"
        >
